...
## Architecture
![Azure Environment](screenshots/azure-architecture.png)
## Network Design
...
- TCP/IP and port troubleshooting
## Key Takeaways
This project has helped expose me to the Azure environment, I am now more familiar with basic cloud concepts and configurations through practical methods.
